## ament_package (rolling) - 0.18.3-2

The packages in the `ament_package` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bin/bloom-release ament_package -r rolling --override-release-repository-url https://github.com/ros2-dyn-gbp/ament_package-release.git` on `Thu, 16 Apr 2026 22:06:08 -0000`
...
- rosdistro version: `0.17.2-2`
- old version: `0.17.2-2`
...
## ament_package (rolling) - 0.18.3-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_package` on `Wed, 08 Apr 2026 10:55:19 -0000`
...
## ament_package (humble) - 0.14.2-1

The packages in the `ament_package` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble ament_package` on `Fri, 13 Feb 2026 19:41:34 -0000`
...
## ament_package (jazzy) - 0.16.5-1

The packages in the `ament_package` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --track jazzy --rosdistro jazzy ament_package` on `Wed, 21 Jan 2026 17:23:20 -0000`
...
- upstream repository: https://github.com/ament/ament_package.git
- release repository: https://github.com/ros2-gbp/ament_package-release.git
- rosdistro version: `0.16.4-1`
- old version: `0.16.4-1`
...
## ament_package (rolling) - 0.18.2-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling --track rolling ament_package` on `Fri, 28 Nov 2025 12:50:10 -0000`
...
## ament_package (rolling) - 0.18.1-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_package` on `Wed, 30 Jul 2025 12:13:23 -0000`
...
## ament_package (humble) - 0.14.1-1

The packages in the `ament_package` repository were released into the `humble` distro by running `/usr/bin/bloom-release --rosdistro humble --track humble ament_package` on `Wed, 21 May 2025 08:28:54 -0000`
...
- upstream repository: https://github.com/ament/ament_package.git
- release repository: https://github.com/ros2-gbp/ament_package-release.git
- rosdistro version: `0.14.0-4`
- old version: `0.14.0-4`
...
## ament_package (rolling) - 0.18.0-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release ament_package -r rolling` on `Thu, 24 Apr 2025 17:40:08 -0000`
...
## ament_package (rolling) - 0.17.2-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/home/cottsay/infra_ws/install/bloom/bin/bloom-release ament_package -r rolling` on `Thu, 17 Apr 2025 22:01:38 -0000`
...
## ament_package (jazzy) - 0.16.4-1

The packages in the `ament_package` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy --track jazzy ament_package` on `Sun, 06 Apr 2025 07:11:44 -0000`
...
- upstream repository: https://github.com/ament/ament_package.git
- release repository: https://github.com/ros2-gbp/ament_package-release.git
- rosdistro version: `0.16.3-3`
- old version: `0.16.3-3`
...
## ament_package (rolling) - 0.17.1-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_package` on `Mon, 17 Jun 2024 15:13:12 -0000`
...
## ament_package (rolling) - 0.17.0-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release ament_package --rosdistro rolling --non-interactive` on `Fri, 26 Apr 2024 10:58:50 -0000`
...
- upstream repository: https://github.com/ament/ament_package.git
- release repository: https://github.com/ros2-gbp/ament_package-release.git
- rosdistro version: `0.16.3-2`
- old version: `0.16.3-2`
...
## ament_package (rolling) - 0.16.3-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_package` on `Wed, 24 Jan 2024 14:47:45 -0000`
...
## ament_package (rolling) - 0.16.2-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_package` on `Fri, 12 May 2023 14:02:17 -0000`
...
## ament_package (rolling) - 0.16.1-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --track rolling --rosdistro rolling ament_package` on `Thu, 11 May 2023 13:21:34 -0000`
...
## ament_package (rolling) - 0.16.0-1

The packages in the `ament_package` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling ament_package` on `Thu, 27 Apr 2023 00:41:49 -0000`
...
## ament_package (rolling) - 0.15.3-1
...
## ament_package (rolling) - 0.14.0-1
...
## ament_package (eloquent) - 0.8.8-1
